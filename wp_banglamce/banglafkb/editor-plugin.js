...
(function() {
		...
		tinymce.create('tinymce.plugins.banglafkb', {		
		init : function(ed, url) {				
			ed.addButton( 'banglafkb', {
	            text: 'My test button',
	            icon: false,
	            onclick: function() {
			...
			//setup : function (ed) {
				ed.onKeyPress.add(
					function (ed, evt) 
					{
						//console.debug('Key press event: ' + evt.keyCode);
    ...
    // tinymce.PluginManager.add('banglafkb', function( editor, url ) {
    //     editor.addButton( 'banglafkb', {
    //         text: 'My test button',
    //         icon: false,
    //         onclick: function() {
    ...
    //     });
    // });
    	tinymce.PluginManager.add('banglafkb', tinymce.plugins.banglafkb);
})();